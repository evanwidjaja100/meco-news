...
class TestAppFull(unittest.TestCase):
    ...
    def test_collectors_edge(self):
        from meco_news.collectors import _bounded_text, _repair_xml, _parse_date
    ...
    def test_ranking_and_models(self):
        from meco_news.ranking import rank_item
    ...
    def test_telegram_rendering(self):
        ...
        item = NewsItem(
            title="t" * 600, url="https://example.com/t", source="S" * 200, summary="s" * 3000, topic_label="T", relevance_reason="R"
        )
